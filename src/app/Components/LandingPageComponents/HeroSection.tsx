 ...
 <div className='lg:text-6xl text-4xl text-white relative z-50 lg:left-[5vw] lg:top-[39vh] lg:w-[40vw] w-[90vw]  left-5 top-[70vh] flex flex-row gap-10'>
  ...
  <p className='relative top-5 lg:top-0'>Hi, I'm Kerim</p>
   ...
   <div className=' text-base mt-4 flex flex-col gap-3 lg:mt-[3vh]'> 
        <div className='flex flx-row gap-2'><CiLocationOn  /> <p className='relative bottom-[0.3vh]'> Addis Ababa,Ethiopia</p>        </div>
        <div className='flex flx-row gap-2'><IoCodeSlashSharp /> <p className='relative bottom-[0.3vh]'>3+ years of experience</p>        </div>
        <div className='flex flx-row gap-2'><FaBirthdayCake /><p className='relative bottom-[0.3vh]'> 23 years old</p>        </div>
        <div className='flex flx-row gap-2'><FaReact />        <p className='relative bottom-[0.3vh]'> MERN Stack Engeneer</p>        </div>
