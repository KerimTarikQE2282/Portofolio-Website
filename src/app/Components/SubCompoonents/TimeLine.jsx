...
if(year==1993){
    ...
    Accomplishments=(
        <div className='mt-[8vh] ml-[5vw]'>
        <p className='text-2xl font-bold text-white'>Noteworthy achievement of Year 2019</p>
        <p className='mt-[3vh] text-white'>
        Our journey began at the University of Alberta, where initial studies on fair screening for at-risk drivers laid our foundation.
        </p>
    </div>
  ...
  return (
    ...
    <ol class="items-center sm:flex ml-[10vw]">
        ...
        <button class="mt-3 sm:pe-8 bg-[#e6effd] flex justify-center p-3 pl-7  border-2 border-[#3d86ed] relative right-[3vw] bottom-[2vh] rounded-full pt-5 " onClick={()=>{setYear(2015)}}>
